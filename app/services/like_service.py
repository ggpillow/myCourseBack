"""
Сервис лайков курсов.

Реализует toggle-семантику: один публичный метод toggle_like
переключает лайк (ставит, если не было, и убирает, если был),
возвращая клиенту новое состояние и актуальное количество лайков.
Перед переключением проверяет существование курса (404, если нет).
"""
